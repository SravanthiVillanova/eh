...
<body>
 ...
 <!-- Page Content -->
      ...
      <div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
			<ul class="nav nav-sidebar">
				<li class="active">
					<a href="diabetes.php" role="button" class="btn btn-link" id="diabetes_page">Diabetes</a>
				</li>
				<li>
					<a href="diabetes_age_per_lineChart.php" role="button" class="btn btn-link" id="line_chart">All States Line Chart</a>
				</li>
				<li>
					<a href="diabetes_age_per_bar_chart.php" role="button" class="btn btn-link" id="vert_bar">Age and Year wise Bar Chart</a>
				</li>
				<li>
					<a href="diabetes_age_high_states_per.php" role="button" class="btn btn-link" id="hor_bar">Highest Percent States</a>
				</li>
				<li>
					<a href="diabetes_age_per_stack_chart.php" role="button" class="btn btn-link" id="stack_chart">All States Stack Chart</a>
				</li>
			</ul>
        </div>
        <!-- Post Content Column -->
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <!-- Title -->
          <h1 class="mt-4">Diabetes Rate by State</h1>
		    <hr>
			...
			<p style="font-size:7px">Source: 
				<a href="https://stateofobesity.org/diabetes/">https://stateofobesity.org/diabetes/</a>
			</p>
        </div>
	...
	function imgCall(y) {
		$("#svg_div").html('');
		var img_path = 'images/diabetes_adults_' + y + '.png';
