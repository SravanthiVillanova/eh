...
<html lang="en">
	...
	<title>Horizontal bar chart - diabetes</title>	
    ...
    <div class="container">
      ...
      <div class="row">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <!-- Title -->
          <h3 class="mt-4">Diabetes by age group - Bar Chart</h1>
...
function ajaxCall(yr, age) {
	$("#svg_div").html('');
		$.ajax({
			method: 'post',
			url: 'src/diabetes_age_per_bar_chart.php',
			data: {
				age: age,
				year: yr
			},
...
//d3.json("src/test_bar.php", function(error, data) {
