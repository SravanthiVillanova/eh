...
<html lang="en">
	...
	<title>Obesity Multi Line Chart</title>
...
<body>
 ...
 <!-- Page Content -->
    <div class="container">
      ...
      <div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
			<ul class="nav nav-sidebar">
				<li class="active">
					...
					<a href="#" role="button" class="btn btn-link Agbtn active" id="Total_Adults">Total_Adults</a>
				</li>
				<li>
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <!-- Title -->
          <h1 class="mt-4">Obesity by Age group - Line Chart</h1>
			<div id="svg_div">
			</div>
        </div>
	...
	function ajaxCall(ag) {
	$("#svg_div").html('');
		$.ajax({
			method: 'post',
			url: 'src/obesity_age_per_line.php',
			data: {
				age: ag
			},
			dataType: "json",
	...
	//Dimensions and padding
            ...
            //d3.json("src/diabetes-age-adults-per.php", function(error, data) {
				...
				*/
				...
				var years = d3.keys(data[0]).slice(0, 10-4); //
