...
<html lang="en">
	...
	<title>High Obesity Percentage States - Bar Chart</title>
    ...
    <div class="container">
      ...
      <div class="row">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <!-- Title -->
          <h1 class="mt-4">High obesity percent states by age group - Bar Chart</h1>
...
function ajaxCall(yr, age) {
	$("#svg_div").html('');
		$.ajax({
			method: 'post',
			url: 'src/obesity_age_high_states_per.php',
			data: {
				age: age,
				year: yr
			},
